/*Упражение 7.3 добавить именованные константы */
/*
...
double const_declaration()
{
	...
	double d = expression();
	var_names.push_back(Variable(name,d,true));
	return d;
}
